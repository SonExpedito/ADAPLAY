    ...
    <div class="timeline-items">
      <div class="timeline-item">
        ...
        <img src="images/timeline1.png">
          ...
          <p>A ideia original do trabalho foi criada ali, em ser uma loja de brinquedos que oferecesse tanto brinquedos comuns quanto adaptados,
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <p>Esse foi o protótipo inicial do projeto, no qual já apresentava os recursos de forma visual (devido a utilizar apenas frontend) 
      ...
      <div class="timeline-item">
        ...
        <img src="images/timeline3.png">
          ...
          <p>Após o fim do primeiro ano do projeto, para que ele continuasse evoluindo, ocorreu um processo de Rebranding, que consistia na mudança da logo e das cores, 
      ...
      <div class="timeline-item">
        ...
        <div class="timeline-content">
          ...
          <p>Após dois anos desde a concepção da ideia de uma loja de brinquedos adaptada, o projeto chegou ao fim neste ano. 
